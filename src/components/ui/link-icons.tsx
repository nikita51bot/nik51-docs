export function ModrinthLogo(
    props: Readonly<React.SVGProps<SVGSVGElement>>,
) {
    const { className, style, ...other } = props;
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" fillRule="evenodd" fill="#1bd96a" strokeLinejoin="round" strokeMiterlimit="2" clipRule="evenodd"
            viewBox="0 0 593 593" className={className} aria-hidden="true" data-v-e9a225e3="" style={style} {...other}>
            <g fill="var(--color-brand)" data-v-e9a225e3="">
...
export function CurseForgeLogo(
    props: Readonly<React.SVGProps<SVGSVGElement>>,
) {
    const { className, style, ...other } = props;
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" clipRule="evenodd"
            viewBox="0 0 30 20" className={className} aria-hidden="true" data-v-e9a225e3="" style={style} {...other}>
            <path d="M22.4108 6.04039C22.4108 6.04039 28.4033 5.07094 29.3497 2.24352H20.1699V0H0L2.48469 2.95793V5.98856C2.48469 5.98856 8.75416 5.6541 11.1793 7.54079C14.4989 10.6975 7.44568 14.9645 7.44568 14.9645L6.23622 19.0705C8.12751 17.2229 11.7321 14.8329 18.3411 14.9481C15.826 15.7636 13.2971 17.0373 11.3284 19.0705H24.6884L23.4303 14.9645C23.4303 14.9645 13.7473 9.10645 22.4108 6.04039Z" fill="white"></path>
        </svg>
    );
}
